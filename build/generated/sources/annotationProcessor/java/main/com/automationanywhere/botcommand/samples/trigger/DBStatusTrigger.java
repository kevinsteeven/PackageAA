...
public class DBStatusTrigger implements Trigger3 {
  ...
  public void startListen(Trigger3ListenerContext triggerListenerContext,
    ...
    if(parameters.containsKey("driverClassName") && parameters.get("driverClassName") != null && parameters.get("driverClassName").get() != null) {
      ...
      if(!(convertedParameters.get("driverClassName") instanceof String)) {
        throw new TriggerException(MESSAGES_GENERIC.getString("generic.UnexpectedTypeReceived","driverClassName", "String", parameters.get("driverClassName").get().getClass().getSimpleName()));
      }
    }
    ...
    if(parameters.containsKey("jdbcUrl") && parameters.get("jdbcUrl") != null && parameters.get("jdbcUrl").get() != null) {
      ...
      if(!(convertedParameters.get("jdbcUrl") instanceof String)) {
        throw new TriggerException(MESSAGES_GENERIC.getString("generic.UnexpectedTypeReceived","jdbcUrl", "String", parameters.get("jdbcUrl").get().getClass().getSimpleName()));
      }
    }
    ...
    if(parameters.containsKey("userName") && parameters.get("userName") != null && parameters.get("userName").get() != null) {
      ...
      if(!(convertedParameters.get("userName") instanceof String)) {
        throw new TriggerException(MESSAGES_GENERIC.getString("generic.UnexpectedTypeReceived","userName", "String", parameters.get("userName").get().getClass().getSimpleName()));
      }
    }
    ...
    if(parameters.containsKey("password") && parameters.get("password") != null && parameters.get("password").get() != null) {
      ...
      if(!(convertedParameters.get("password") instanceof SecureString)) {
        throw new TriggerException(MESSAGES_GENERIC.getString("generic.UnexpectedTypeReceived","password", "SecureString", parameters.get("password").get().getClass().getSimpleName()));
      }
    }
    ...
    if(parameters.containsKey("sqlQuery") && parameters.get("sqlQuery") != null && parameters.get("sqlQuery").get() != null) {
      ...
      if(!(convertedParameters.get("sqlQuery") instanceof String)) {
        throw new TriggerException(MESSAGES_GENERIC.getString("generic.UnexpectedTypeReceived","sqlQuery", "String", parameters.get("sqlQuery").get().getClass().getSimpleName()));
      }
    }
