...
public class JMSQueueTrigger implements Trigger3 {
  ...
  public void startListen(Trigger3ListenerContext triggerListenerContext,
    ...
    if(parameters.containsKey("brokerURL") && parameters.get("brokerURL") != null && parameters.get("brokerURL").get() != null) {
      ...
      if(!(convertedParameters.get("brokerURL") instanceof String)) {
        throw new TriggerException(MESSAGES_GENERIC.getString("generic.UnexpectedTypeReceived","brokerURL", "String", parameters.get("brokerURL").get().getClass().getSimpleName()));
      }
    }
    ...
    if(parameters.containsKey("queueName") && parameters.get("queueName") != null && parameters.get("queueName").get() != null) {
      ...
      if(!(convertedParameters.get("queueName") instanceof String)) {
        throw new TriggerException(MESSAGES_GENERIC.getString("generic.UnexpectedTypeReceived","queueName", "String", parameters.get("queueName").get().getClass().getSimpleName()));
      }
    }
